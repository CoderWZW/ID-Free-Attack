...
def attack_parse_args():
    ...
    # ===== Genneral parameters ===== #
    parser.add_argument('--attackCategory', type=str, default="Modal", metavar='N',help='["Black","Gray", "White"]')
    parser.add_argument('--attackModelName', type=str, default="gptAttack", metavar='N',help='[TextFooler_RA, TextFooler_BA,TextFooler, Copycat, Copycat_RA, Copycat_BA, TextBugger_RA, TextBugger_BA, TextBugger,NoneAttack, RandomAttack, BandwagonAttack,  ...]')
    ...
    parser.add_argument('--maliciousUserSize', type=float, default="10", metavar='N',
    ...
    parser.add_argument('--Epoch', type=int, default=1, metavar='N', help='attack epoch')
    parser.add_argument('--innerEpoch', type=int, default=3, metavar='N', help='inner epoch')
    parser.add_argument('--outerEpoch', type=int, default=5, metavar='N', help='outer epoch')
    ...
    parser.add_argument('--targetSize', type=float, default=1, metavar='N',
